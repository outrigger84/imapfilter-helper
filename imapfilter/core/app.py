...
• All paths are located relative to the project package directory
"""

import imaplib, email, json, re, sys, sqlite3, random
...
DEFAULT_SECRETS_FILE = DATA_DIR / "secrets.json"
DEFAULT_DB_FILE = DATA_DIR / "cache.db"
DEFAULT_LOG_FILE = DATA_DIR / "imapfilter-helper.log"
