"""The interactive rule creation wizard (RuleWizard)."""
...
from core.tools.rule_wizard_core.builder import ConditionGroup, GroupingSpec, RuleBuilder, save_rule
...
from core.tools.rule_wizard_core.patterns import EmailPatternExtractor, SubjectPatternExtractor
